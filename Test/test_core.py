...
from PassiveComp import *
from PassiveComp.core import createSeries
...
class TestCreateSeries(unittest.TestCase):
    ...
    def test_happyPathE3compareToOrigOutput_shouldAssertEqual(self):
        self.assertEqual(e3,createSeries(3))

    def test_happyPathE6compareToOrigOutput_shouldAssertEqual(self):
        self.assertEqual(e6,createSeries(6))

    def test_happyPathE12compareToOrigOutput_shouldAssertEqual(self):
        self.assertEqual(e12,createSeries(12))

    def test_happyPathE24compareToOrigOutput_shouldAssertEqual(self):
        self.assertEqual(e24,createSeries(24))

    def test_happyPathE48compareToOrigOutput_shouldAssertEqual(self):
        self.assertEqual(e48,createSeries(48))

    def test_happyPathE96compareToOrigOutput_shouldAssertEqual(self):
        self.assertEqual(e96,createSeries(96))

    def test_happyPathE192compareToOrigOutput_shouldAssertEqual(self):
        self.assertEqual(e192,createSeries(192))
